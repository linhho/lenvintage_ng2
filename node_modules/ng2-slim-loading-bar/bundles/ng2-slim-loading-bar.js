System.registerDynamic("src/slim-loading-bar.component", ["@angular/core", "./slim-loading-bar.service", "./slim-loading-bar.utils"], true, function ($__require, exports, module) {
...
System.registerDynamic("index", ["@angular/core", "@angular/common", "./src/slim-loading-bar.component", "./src/slim-loading-bar.service"], true, function ($__require, exports, module) {
    // Copyright (C) 2016 Sergey Akopkokhyants
    // This project is licensed under the terms of the MIT license.
    // https://github.com/akserg/ng2-slim-loading-bar
    'use strict';
    ...
    var SlimLoadingBarModule = function () {
        ...
        SlimLoadingBarModule = __decorate([core_1.NgModule({
        ...
        }), __metadata('design:paramtypes', [])], SlimLoadingBarModule);
